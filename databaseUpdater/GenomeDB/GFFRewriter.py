...
class GFFRewriter:
    ...
    '''
    #def addColor(self, dbInfo={'user' : 'ktcho', 'password' : 'password', 'db' : 'go'}, hamapName=None):
    def addColor(self, dbInfo={'user' : 'ktcho', 'password' : 'deb_chadodb', 'db' : 'go'}, hamapName=None):
        if (not self.error):
            try:
                if (hamapName):
            ...
            try:
                ...
                print 'Error connecting to local Gene Ontology Database'
                #return
                sys.exit(1)
            ...
            try:
                ...
                print "Could not find the biological processes in the local Gene Ontology"
                sys.exit(1)
