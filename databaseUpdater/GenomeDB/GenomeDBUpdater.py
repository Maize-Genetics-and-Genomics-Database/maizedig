    ...
    def __processGffFilesNew(self, newOrganismDirs):
        for newOrganism in newOrganismDirs:
            ...
            if (gff and gbk):
                ...
                # debugging - ktcho
                #print id   # If it prints '0', that means there is an organism already in the DB with same name.

                if id != 0:     # modified by ktcho, 2016.01.16
