...
$(function () {
        $('.tag').click(function(event) {
            $('#' + event.target.id + "_genes").css({'top':event.pageY-30, 'left':event.pageX});
            $('#' + event.target.id + "_genes").toggle();
        });
});
    
$(function () {
        $('.gene_close_text').click(function(event) {
            $('#' + event.target.id.replace("_close", "_genes")).toggle();
        });
});